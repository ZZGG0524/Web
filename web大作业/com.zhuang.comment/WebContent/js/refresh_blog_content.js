...
function blog_content_response() {
	if(blog_content_xhr.readyState == 4) {
		if(blog_content_xhr.status == 200) {
            ...
            document.getElementById("blog_title").innerHTML = "标题:  " + json_blog.blog_title;
            document.getElementById("blog_people_id").innerHTML = "用户id:  " + json_blog.blog_people_id;
            document.getElementById("blog_time").innerHTML = "发布时间:  " + json_blog.blog_time;
            document.getElementById("blog_content").innerHTML = "博客内容:  " + json_blog.blog_content;
			...
			document.getElementById("request").innerHTML = "操作失败!  "+blog_content_xhr.status;
		}
	}
}